            ...
            for (const index in links) {
                ...
                rp(links[index])
                    .then(html => {
                        ...
                        // specific use case for homepage
                        // last two "p" tags are irrelevant, could make identifier more specific
                        content.pop()
                        content.pop()
...
exports.fiveAfterTopStory = fiveAfterTopStory